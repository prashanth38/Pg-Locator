...
public class ViewUserPg extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i=new Intent(getApplicationContext(),ViewOnePg.class);
                 i.putExtra("obj",pgDetails);
                startActivity(i);
            }
        });
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(ViewUserPg.this);
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                           PgDetails pgDetails=pgDetailsList.get(position);
                             showDialogUpdate(ViewUserPg.this, pgDetails);
    ...
    private void showDialogDelete(final PgDetails pgDetails) {
        ...
        final AlertDialog.Builder dialogDelete = new AlertDialog.Builder(ViewUserPg.this);
    ...
    private void showDialogUpdate(ViewUserPg activity, final PgDetails pgDetails) {
       ...
       imagepath=pgDetails.getImgpath();
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions(ViewUserPg.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.ACCESS_FINE_LOCATION,Manifest.permission.ACCESS_COARSE_LOCATION},REQUEST_GALLERY_CODE);
            }
        });
        ...
        imgagemap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ViewUserPg.this,MapsActivity.class);
            ...
            ref.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(ViewUserPg.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        }
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(ViewUserPg.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
